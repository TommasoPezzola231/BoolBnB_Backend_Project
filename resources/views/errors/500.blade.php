...
@section('content')
    <div class="col-12 d-flex flex-column justify-content-end align-items-center text-center p-2 cursor-pointer">
        <h1 class="mt-5">Errore 500</h1>
        <h2>Errore del Server Interno</h2>
        <span class="fa-solid fa-triangle-exclamation my_color"></span>
        <p class="mt-3 my_color">Si è verificato un errore imprevisto lato server. Ci scusiamo per l'inconveniente</p>
